...
{
 char s2[128] = {0};
 char *s1[] = { "a-z-", "z-a-", "-1-6-", "a-ee-a", "a-R-L", "1-9-1", "5-5", ((void *)0) };
 int i = 0;
 ...
 printf("%d\n", ((('a' >= '0') && ('a' <= '9')) ? 1 : 0) && ((('R' >= '0') && ('R' <= '9')) ? 1 : 0));
 printf("%d\n", ((('a' >= 'a') && ('a' <= 'z')) ? 1 : 0)ls && ((('R' >= 'a') && ('R' <= 'z')) ? 1 : 0));
 printf("%d\n", (((('a' >= 'A') && ('a' <= 'Z')) ? 1 : 0) && ((('R' >= 'A') && ('R' <= 'Z')) ? 1 : 0)));
 printf("%d\n", ('R' >= 'a') && ('R' <= 'z'));
 printf("%d\n", ('a' >= 'a') && ('a' <= 'z'));
 printf("%d\n", ((('a' >= 'a') && ('a' <= 'z')) ? 1 : 0));
 printf("%d\n", ((('R' >= 'a') && ('R' <= 'z')) ? 1 : 0));
...
void expand(char s1[], char s2[])
{
 ...
 while(s1[i] != '\0')
 {
  if (s1[i] == '-')
  {
   ...
   {
    if (((((s1[i-1] >= '0') && (s1[i-1] <= '9')) ? 1 : 0) && (((s1[i+1] >= '0') && (s1[i+1] <= '9')) ? 1 : 0)) || ((((s1[i-1] >= 'a') && (s1[i-1] <= 'z')) ? 1 : 0) && (((s1[i+1] >= 'a') && (s1[i+1] <= 'z')) ? 1 : 0)) || ((((s1[i-1] >= 'A') && (s1[i-1] <= 'Z')) ? 1 : 0) && (((s1[i+1] >= 'A') && (s1[i+1] <= 'Z')) ? 1 : 0)))
    {
